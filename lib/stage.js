...
//        this.context.imageSmoothingEnabled = false;
    ...
    Stage.prototype.sort_objects = function(objects){
        ...
        Math.bubble_sort(objects,function(a,b){
...
//            this.context.fillRect(0,0,Config.screen_width,Config.screen_height);
//            this.context.restore();
//        }else{
//            this.context.clearRect(0,0,Config.screen_width,Config.screen_height);
//        }

        var tickable_objects = this.tickable_objects;
        var c = this.context;
        var remove_queue = this.remove_queue;
        var i = remove_queue.length;
        //console.log(this.remove_queue);
        while (i--) {
            var o = remove_queue[i];
            //console.log(o);
            o.clear(c);
            if(o.get_parent() instanceof Stage){
                var index = tickable_objects.indexOf(o);
                if(index !== -1){
                    tickable_objects.splice(index,1);
        ...
        this.clear_children(tickable_objects,c);
    };
