(function(window, undefined) {
    ...
    Car.prototype.initialize = function() {
        ...
        this.images = ['car_animation','yellow_car_animation','blue_car_animation'];
        

        var sprite_sheet = new SpriteSheet([{
                image: ContentManager.images[this.images[ Math.random_int(0,this.images.length-1) ]],
                frames: {x: 2, y: 1},
                animations: {
    ...
    Car.prototype.move = function() {
        ...
        pos.add(this.velocity.clone().scale(Ticker.step));
        this.set_position(pos.x, pos.y);

//                if(Math.round(pos.x,0)%10==0 && Math.round(pos.y,0)%10==0)
//                log(pos.x+" "+pos.y);
        ...
        if (distance_traveled > this.car_size) {
